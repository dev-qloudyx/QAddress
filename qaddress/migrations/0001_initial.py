    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CC', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qaddress.countydata')),
                ('DD', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qaddress.districtdata')),
            ],
        ),
        migrations.AddField(
            model_name='countydata',
            name='DD',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qaddress.districtdata'),
        ),
    ]
